...
/**
 * MarcasVehiculosSearch represents the model behind the search form of `\frontend\models\MarcasVehiculos`.
 */
class MarcasVehiculosSearch extends MarcasVehiculos
{
    ...
    public function search($params)
    {
        ...
        //$query = $query->where(['id_empresa'=>Yii::$app->user->identity->empresa_id]);
