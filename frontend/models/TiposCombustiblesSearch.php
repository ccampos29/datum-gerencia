...
/**
 * TiposCombustiblesSearch represents the model behind the search form of `\frontend\models\TiposCombustibles`.
 */
class TiposCombustiblesSearch extends TiposCombustibles
{
    /**
     * {@inheritdoc}
     */
