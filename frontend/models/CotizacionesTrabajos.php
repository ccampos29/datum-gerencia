...
/**
 * This is the model class for table "cotizaciones_trabajos".
 *
 * @property int $id
 * @property int $cotizacion_id Dato intermedio de las cotizaciones
 * @property int $trabajo_id Dato intermedio de los trabajos
 ...
 */
class CotizacionesTrabajos extends MyActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['cotizacion_id', 'trabajo_id', 'cantidad', 'valor_unitario', 'descuento_unitario', 'tipo_impuesto_id'], 'required'],
            [['cotizacion_id', 'trabajo_id', 'cantidad', 'valor_unitario', 'tipo_impuesto_id', 'creado_por', 'actualizado_por', 'empresa_id'], 'integer'],
