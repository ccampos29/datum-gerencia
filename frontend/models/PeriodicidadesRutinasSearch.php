...
/**
 * PeriodicidadesRutinasSearch represents the model behind the search form of `frontend\models\PeriodicidadesRutinas`.
 */
class PeriodicidadesRutinasSearch extends PeriodicidadesRutinas
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'vehiculo_id', 'rutina_id', 'tipo_periodicidad', 'creado_por', 'actualizado_por'], 'integer'],
     ...
     */
    public function search($params, $idRutina)
    {
        $query = PeriodicidadesRutinas::find()->where(['rutina_id' => $idRutina]);
