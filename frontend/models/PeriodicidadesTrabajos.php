...
/**
 * This is the model class for table "periodicidades_trabajos".
 *
 * @property int $id
 * @property int $vehiculo_id Es el automovil al que se le reporta la novedad
 * @property int $trabajo_id Es el trabajo asignado a la periodicidad
 ...
 * @property int $tipo_periodicidad_id Es el tipo de periodicidad
 ...
 */
class PeriodicidadesTrabajos extends MyActiveRecord
{
    ...
    {
        return 'periodicidades_trabajos';
    }
