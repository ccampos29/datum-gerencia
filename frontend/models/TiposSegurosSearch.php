...
/**
 * TiposSegurosSearch represents the model behind the search form of `\frontend\models\TiposSeguros`.
 */
class TiposSegurosSearch extends TiposSeguros
{
    /**
     * {@inheritdoc}
     */
