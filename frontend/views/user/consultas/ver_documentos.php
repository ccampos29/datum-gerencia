...
<div class="usuarios-documentos-usuarios-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            'Fecha de expiracion' => [
                ...
                'value' => function ($data) {
                    return date('Y-m-d', strtotime($data->fecha_expedicion));
                },
    ...
    <div class="form-group pull-left">
        <a class="btn btn-default" href="<?= Url::to(['user/consulta-personal']) ?>"><i class="fa fa-arrow-left" aria-hidden="true"></i> Volver </a>
    </div>
