...
?>
<div class="periodicidades-rutinas-view">
    ...
    <?= DetailView::widget([
        ...
        <div class="form-group pull-left">
            <a class="btn btn-default" href="<?= Url::to(['periodicidades-rutinas/index?idRutina=' . $model->rutina_id]) ?>"><i class="fa fa-arrow-left" aria-hidden="true"></i> Volver </a>
        </div>
