...
<div class="periodicidades-rutinas-form">
    ...
    <div class="container-fluid col-12">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <label>
                    <i class="fa fa-briefcase" aria-hidden="true"></i> Rutina
                </label>
                <input class="form-control" readOnly="true" id="rutina-mostrar">
                <?= $form->field($model, 'rutina_id')->textInput(['id' => 'rutina', 'class' => 'hidden', 'value' => $rutina->nombre])->label(false) ?>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <label>
        ...
        <div>
            <div class="form-group pull-left">
                <a class="btn btn-default" href="<?= Url::to(['periodicidades-rutinas/index?idRutina=' . $idRutina]) ?>"><i class="fa fa-arrow-left" aria-hidden="true"></i> Volver </a>
            </div>
